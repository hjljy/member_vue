  ...
  <div style="padding: 30px">
    <el-alert title="提示信息" type="warning" show-icon>
      <template slot="title">
        ...
        <div>2 只能重置其他账户的密码，重置后的密码默认为：123456，</div>
      ...
      <div>
        <el-form ref="addForm" class="addForm" :rules="rules" :model="sysUser" label-width="80px">
          ...
          <el-form-item label="所属机构">
            <el-select v-model="sysUser.orgId" placeholder="机构" :disabled="noSelfChange||noShow">
              <el-option label="默认" value="-1" />
            </el-select>
          </el-form-item>
          <el-form-item label="角色权限" prop="roleIds">
            <el-checkbox-group v-model="sysUser.roleIds" :disabled="noSelfChange||noShow">
