<template>
  <div style="padding: 30px">
      ...
      <el-table :border="true" :data="tableData" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
        ...
        <el-table-column align="center" width="260" label="操作">
          <template slot-scope="scope">
            ...
            >编辑</el-button>
            <el-button
              v-permission="['sys:user:rpwd']"
              type="text"
              size="mini"
              @click="handlerpd(scope.row.id)"
            >重置密码</el-button>
            <el-button
              v-permission="['sys:user:page']"
              type="text"
              size="mini"
    ...
    <el-drawer :title="title" :visible.sync="dialog" :show-close="false" size="25%" @close="handleClose('addForm')">
      <div>
...
<script>
import { page, roleList, addUser, disableUser, delUser, updateUser, resetPassword } from '@/api/user'
import { orgList } from '@/api/org'
import { getUserId, getOrgId } from '@/utils/auth'
