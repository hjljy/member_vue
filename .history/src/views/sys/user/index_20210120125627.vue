      ...
      <div>
        <el-form ref="addForm" class="addForm" :rules="rules" :model="sysUser" label-width="80px">
          <el-form-item label="用户账号" prop="userName">
            <el-input v-model="sysUser.userName" placeholder="长度在12个字符以内" :disabled="noChange" />
          </el-form-item>
          <el-form-item label="用户昵称" prop="nickName">
            <el-input v-model="sysUser.nickName" placeholder="长度在8个字符以内" />
          </el-form-item>
          <el-form-item label="用户密码" prop="password" :disabled="noChange">
            <el-input v-model="sysUser.password" type="password" placeholder="长度在6到18个字符" :disabled="noChange" />
          </el-form-item>
