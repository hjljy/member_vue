      ...
      <div>
        ...
        <el-form ref="sysUser" class="addForm" :rules="rules" :model="sysUser" label-width="80px">
          <el-form-item label="用户账号" prop="userName">
            <el-input v-model="sysUser.userName" placeholder="长度在8到12个字符" />
          </el-form-item>
          <el-form-item label="用户昵称" prop="nickName">
            <el-input v-model="sysUser.nickName" placeholder="长度在1到8个字符" />
          </el-form-item>
          <el-form-item label="用户密码" prop="password">
            <el-input v-model="sysUser.password" type="password" placeholder="长度在6到12个字符" />
          </el-form-item>
