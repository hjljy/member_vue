    ...
    <el-dialog title="会员等级" :visible.sync="dialogFormVisible">
      <el-form :model="memberLevel" :inline="true">
        ...
        <el-form-item label="所需成长值:" :label-width="formLabelWidth">
          <el-input v-model="memberLevel.upgradeGrowthValue" :placeholder="maxUpgradeGrowthValue" autocomplete="off" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      ugvMessage: '成长值需要大于' + maxUpgradeGrowthValue,
      tableData: []
    }
  },
  created() {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      addMemberLevel(this.memberLevel)
    }
