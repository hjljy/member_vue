    ...
    <el-dialog title="会员等级" :visible.sync="dialogFormVisible">
      <el-form :model="memberLevel">
        <el-form-item label="等级名称" :label-width="formLabelWidth">
          <el-input v-model="memberLevel.name" autocomplete="off" />
        </el-form-item>
        <el-form-item label="是否默认等级" :label-width="formLabelWidth">
          <el-radio v-model="memberLevel.memberDefault" label="0">否</el-radio>
          <el-radio v-model="memberLevel.memberDefault" label="1">是</el-radio>
        </el-form-item>

        <el-form-item label="等级" :label-width="formLabelWidth">
          <el-select v-model="memberLevel.region" placeholder="请选择活动区域">
