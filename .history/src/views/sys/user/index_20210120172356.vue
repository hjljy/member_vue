      ...
      <div>
        <el-form ref="addForm" class="addForm" :rules="rules" :model="sysUser" label-width="80px">
          <el-form-item label="用户账号" prop="userName">
            <el-input v-model="sysUser.userName" placeholder="长度在12个字符内,不能是电话号码" :disabled="noChange" />
          </el-form-item>
          <el-form-item label="用户昵称" prop="nickName">
            <el-input v-model="sysUser.nickName" placeholder="长度在8个字符以内" :disabled="show" />
          </el-form-item>
          <el-form-item v-show="itemShow" label="用户密码" prop="password">
            <el-input v-model="sysUser.password" type="password" placeholder="长度在6到18个字符" :disabled="show" />
          </el-form-item>
          <el-form-item label="用户邮箱" prop="email">
            <el-input v-model="sysUser.email" placeholder="用户邮箱：xxx@xxx.com" :disabled="show" />
          </el-form-item>
          ...
          <el-form-item label="生日" prop="birthday">
            <el-date-picker v-model="sysUser.birthday" type="date" placeholder="选择日期" style="width: 100%;" :disabled="show" />

          </el-form-item>
          <el-form-item label="性别">
            <el-radio-group v-model="sysUser.sex" :disabled="show">
          ...
          <el-form-item label="用户描述" porp="description">
            <el-input v-model="sysUser.description" type="textarea" :disabled="show" placeholder="这个人很神秘，什么都没有留下" />
          </el-form-item>
          <el-form-item>
...
<script>
import { page, roleList, addUser, disableUser, delUser } from '@/api/user'
  ...
  methods: {
    ...
    handleEdit(type, row) {
      if (type === 0) {
        ...
        this.title = '编辑用户'
        this.sysUser = row
        this.sysUser.roleIds = row.roles.map(item => item.id)
      } else if (type === 2) {
        this.dialog = true
        this.noChange = true
        this.itemShow = false
