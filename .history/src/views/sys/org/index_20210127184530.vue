<template>
  <div style="padding: 30px">
    ...
    <el-form :inline="true" :model="queryParam" class="form-inline">
      ...
      <el-table :border="true" :data="tableData" :header-cell-style="{background:'#eef1f6',color:'#606266'} :tree-props="{children: 'children', has-children: -has-children->
...
<script>
import { addUser, disableUser, delUser, updateUser, resetPassword } from '@/api/user'
