<template>
  ...
  <el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="upgradeGrowthValue" label="邮箱"> </el-table-column>
      <el-table-column prop="upgradeGrowthValue" label="部门"> </el-table-column>
      <el-table-column prop="upgradeGrowthValue" label="角色"> </el-table-column>
