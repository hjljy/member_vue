<template>
  <div style='padding: 30px'>
    ...
    <el-form :inline='true' :model='queryParam' class='form-inline'>
      ...
      <el-form-item>
        <el-button type='primary' v-permission="['sys:user:add']" > <router-link to="/sys/user/add">新增 </router-link>  </el-button>
      </el-form-item>
      <el-table :border="true" :data='tableData' :header-cell-style="{background:'#eef1f6',color:'#606266'}">
        ...
        <el-table-column v-permission="['sys:user:upadateaa']"  align="center" label='操作'>
          <template slot-scope='scope'>
            <el-button v-permission="['sys:user:upadateaa']"
